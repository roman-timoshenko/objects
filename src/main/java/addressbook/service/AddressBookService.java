...
import addressbook.dto.AddressBookEntry;
...
public class AddressBookService {
    ...
    public AddressBookEntry addContact(String firstName, String lastName, String countryName, String town, String street, String postalCode, int house, int flat, String phone) throws SQLException {
        Contact contact = contactDao.add(firstName, lastName);
        Address address = addressDao.add(town, street, postalCode, house, flat);
        ...
        return new AddressBookEntry(contact, address,country , phone);
    }

    public AddressBookEntry getContact(String firstName, String lastName) throws SQLException {
